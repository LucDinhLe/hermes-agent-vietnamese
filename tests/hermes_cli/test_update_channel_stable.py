...
class TestParseReleaseTag:
    ...
    def test_v31_successor_is_newer_than_all_prior_candidates_and_vi39(self):
        candidate = _parse_release_tag("vi-v0.31.0-7")
        sixth_candidate = _parse_release_tag("vi-v0.31.0-6")
        fifth_candidate = _parse_release_tag("vi-v0.31.0-5")
        ...
        assert (
            ...
            and sixth_candidate is not None
            and fifth_candidate is not None
...
class TestLatestPublicReleaseFromGitHub:
    ...
    def test_v31_successor_wins_over_all_prior_candidates_and_published_vi39_line(self):
        releases = [
            {"tag_name": "vi-v0.31.0-7", "draft": False, "prerelease": True},
            {"tag_name": "vi-v0.31.0-6", "draft": False, "prerelease": True},
        ...
        assert _latest_public_release_tag_from_releases(releases) == "vi-v0.31.0-7"
