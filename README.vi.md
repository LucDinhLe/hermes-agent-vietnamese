...
> **Mới: [Hermes Vietnamese v31.0](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/tag/vi-v0.31.0-3)** (`vi-v0.31.0-3`) là **community prerelease, chưa phải stable**. Candidate này giữ Agents và Gateway đúng backend owner, đồng thời sửa Connector không bỏ sót cookie website trên Chrome hiện hành mà vẫn chặn cookie phân vùng. Candidate `-3` thay `vi-v0.31.0-2` chưa công khai; tag/draft cũ được giữ nguyên. `vi-v0.20.0-25` vẫn là bản pilot Latest/tải mặc định. Trang phát hành phân biệt rõ artifact đã smoke trên máy thật và artifact mới chỉ build.
>
> Tải candidate: [Windows x64](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-Windows-x64-Setup.exe) · [Windows ARM64](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-Windows-arm64-Setup.exe) · [macOS Apple Silicon](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-macOS-Apple-Silicon.dmg) · [macOS Intel](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-macOS-Intel.dmg) · [Linux x64 DEB](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-Linux-x64.deb) · [Linux ARM64 DEB](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-Linux-arm64.deb) · [Linux x64 RPM](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-Linux-x64.rpm) · [Linux ARM64 RPM](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-Linux-arm64.rpm) · [Linux x64 AppImage](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-Linux-x64.AppImage) · [Linux ARM64 AppImage](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-3/Hermes-Vietnamese-Linux-arm64.AppImage).
