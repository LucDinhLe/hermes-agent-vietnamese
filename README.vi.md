...
> **Mới: [Hermes Vietnamese v31.0](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/tag/vi-v0.31.0-2)** (`vi-v0.31.0-2`) là **community prerelease, chưa phải stable**. Candidate này đưa Agents và điều khiển Gateway theo đúng backend owner vào từng phiên, thay thế candidate `vi-v0.31.0-1` chưa được promotion mà không sửa tag/draft cũ. `vi-v0.20.0-25` vẫn là bản pilot Latest/tải mặc định. Trang phát hành phân biệt rõ artifact đã smoke trên máy thật và artifact mới chỉ build.
>
> Tải candidate: [Windows x64](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-Windows-x64-Setup.exe) · [Windows ARM64](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-Windows-arm64-Setup.exe) · [macOS Apple Silicon](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-macOS-Apple-Silicon.dmg) · [macOS Intel](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-macOS-Intel.dmg) · [Linux x64 DEB](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-Linux-x64.deb) · [Linux ARM64 DEB](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-Linux-arm64.deb) · [Linux x64 RPM](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-Linux-x64.rpm) · [Linux ARM64 RPM](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-Linux-arm64.rpm) · [Linux x64 AppImage](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-Linux-x64.AppImage) · [Linux ARM64 AppImage](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.31.0-2/Hermes-Vietnamese-Linux-arm64.AppImage).
