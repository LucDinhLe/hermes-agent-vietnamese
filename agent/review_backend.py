    ...
    *,
    ...
    if provider == "openai-codex":
        ...
        client = _create_openai_client(
            ...
            timeout=timeout,
            max_retries=0,
            # v2026.8.19's helper takes only the OAuth token. The PR's newer
            # base also accepts base_url, but the resolved URL above is already
            # handed to the client and does not change the required headers.
