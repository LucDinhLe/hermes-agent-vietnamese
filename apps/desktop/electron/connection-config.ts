 ...
 * legacy profile-routed path. An explicit `local` is meaningful: it forces the
 * registry's local backend even when the legacy primary is remote. Only an
 * absent/empty id keeps the byte-identical v1 route.
 */
