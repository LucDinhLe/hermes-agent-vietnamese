...
test('apiRequestRegistryConnectionId preserves an explicit force-local route', () => {
  assert.equal(apiRequestRegistryConnectionId({ connectionId: 'local', path: '/x' }), 'local')
})

test('apiRequestRegistryConnectionId resolves null for legacy unscoped routes', () => {
