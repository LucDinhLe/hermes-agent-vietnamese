...
const OPTIONS: ModeOption[] = [
  ...
  {
    mode: 'lite',
    title: 'Gỡ giao diện + agent, giữ dữ liệu',
    description: 'Gỡ ứng dụng và Hermes Agent nhưng giữ cấu hình, cuộc trò chuyện và thông tin đăng nhập để cài lại.',
    consequence: 'giao diện và Hermes Agent; vẫn giữ cấu hình, cuộc trò chuyện và thông tin đăng nhập',
    needsAgent: true
  },
  {
    mode: 'full',
    title: 'Gỡ toàn bộ',
    description: 'Gỡ ứng dụng, agent và toàn bộ dữ liệu: cấu hình, cuộc trò chuyện, tác vụ định kỳ, khóa và nhật ký.',
    consequence: 'TOÀN BỘ giao diện, Hermes Agent, cấu hình, cuộc trò chuyện, khóa và nhật ký',
...
export function UninstallSection() {
  ...
  return (
    <div className="mx-auto mt-8 w-full max-w-2xl">
      <SectionHeading icon={AlertTriangle} title="Khu vực cần thận trọng" />
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Gỡ Hermes</p>
            <p className="text-xs text-muted-foreground">
              Chọn phạm vi cần gỡ. Ứng dụng sẽ đóng để hoàn tất; có thể chạy lại bộ cài bất cứ lúc nào.
            </p>
