...
export const en: Translations = {
  ...
  settings: {
    ...
    about: {
      ...
      communityMaintainer: 'Vietnamese community edition',
  ...
  shell: {
    ...
    statusbar: {
      ...
      contextUsagePanel: {
        ...
        costReference: amount => `API-equivalent value: ${amount} USD`,
        ...
        effectiveCapacity: tokens => `Current route limit: ${tokens}`,
