...
export const zh: Translations = {
  common: {
    ...
    skip: '跳过',
    update: '更新',
    truncatedCharacters: count => `已截断 ${count.toLocaleString('zh-CN')} 个字符 — 使用“复制”获取完整输出。`,
    sessionUsageSummary: (calls, input, output, total) =>
      `用量：${calls.toLocaleString('zh-CN')} 次调用 · ${input.toLocaleString('zh-CN')} 输入 / ${output.toLocaleString('zh-CN')} 输出 · 共 ${total.toLocaleString('zh-CN')}`,
