  ...
  settings: {
    ...
    about: {
      ...
      notifyOnlyReady: version =>
        `الإصدار ${version} متاح. لا يقوم هذا التطبيق بتثبيت التحديثات بنفسه: نزّل المثبّت وتحقق من SHA-256 ثم شغّله.`,
      openDownloadPage: 'افتح صفحة التنزيل',
      notifyOnlyDesc:
        'يكتفي Hermes Vietnamese بإشعارك بالإصدارات الجديدة ولا ينزّل أو يثبّت شيئًا بنفسه؛ نزّل المثبّت من GitHub Releases وتحقق من قيمة التحقق.',
