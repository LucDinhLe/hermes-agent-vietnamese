      ...
      <div className={NOTICE_CLASS} data-slot="aui_agent-delivery-notice">
        <span className="flex items-center justify-center gap-1.5">
          ...
          <span className="wrap-anywhere">
            {pending ? t.assistant.thread.agentMessaging(target) : t.assistant.thread.agentMessaged(target)}
          </span>
        </span>
      </div>
      {!pending && replyBody && (
        <div className={NOTICE_CLASS} data-slot="aui_agent-reply-notice">
          <span className="flex items-center justify-center gap-1.5">
            <AgentGlyph handle={target} />
            <span className="wrap-anywhere">{t.assistant.thread.agentMessageFrom(target)}</span>
          </span>
