...
Mở [trang phát hành vi-v0.20.0-8](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/tag/vi-v0.20.0-8), chọn đúng tệp cho máy và chạy bộ cài. Trong lần mở đầu tiên:
