...
<p align="center">
  <a href="https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/tag/vi-v0.20.0-14"><img src="https://img.shields.io/badge/Tải_bản_vi--v0.20.0--14-Windows_%7C_macOS_%7C_Linux-F97316?style=for-the-badge" alt="Tải Hermes Vietnamese"></a>
...
Mở [trang phát hành vi-v0.20.0-14](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/tag/vi-v0.20.0-14), chọn đúng tệp cho máy và chạy bộ cài. Trong lần mở đầu tiên:
...
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Windows 10/11, chip x64      | [Bộ cài Windows x64](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-Windows-x64-Setup.exe)           |
| Windows 10/11, chip ARM64    | [Bộ cài Windows ARM64](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-Windows-arm64-Setup.exe)       |
| Mac dùng chip Apple M-series | [Bộ cài macOS Apple Silicon](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-macOS-Apple-Silicon.dmg) |
| Mac dùng chip Intel          | [Bộ cài macOS Intel](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-macOS-Intel.dmg)                 |
| Ubuntu/Debian x64            | [Gói Linux x64 `.deb`](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-Linux-x64.deb)                 |
| Ubuntu/Debian ARM64          | [Gói Linux ARM64 `.deb`](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-Linux-arm64.deb)             |
| Fedora/RHEL x64              | [Gói Linux x64 `.rpm`](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-Linux-x64.rpm)                 |
| Fedora/RHEL ARM64            | [Gói Linux ARM64 `.rpm`](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-Linux-arm64.rpm)             |
| Linux khác x64               | [Gói Linux x64 `.AppImage`](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-Linux-x64.AppImage)       |
| Linux khác ARM64             | [Gói Linux ARM64 `.AppImage`](https://github.com/LucDinhLe/hermes-agent-vietnamese/releases/download/vi-v0.20.0-14/Hermes-Vietnamese-Linux-arm64.AppImage)   |
