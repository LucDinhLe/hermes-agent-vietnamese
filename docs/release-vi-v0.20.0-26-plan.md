...
1. Cài sạch v26, boot, onboard, gửi prompt thường và chạy safe tool.
...
8. Cài exact v25 vào profile Hermes cô lập, tạo dữ liệu không nhạy cảm, chạy
   updater tới exact v26; xác minh session Hermes và cookie Hermes giữ đúng chính
   sách, connector mặc định tắt và summary mặc định tắt.
9. Uninstall, reinstall và rollback path đã phê duyệt; không tuyên bố hỗ trợ
   v14 -> v26 nếu chưa có bằng chứng exact-artifact riêng.
...
- `.github/public-release.json` đổi atomically sang tag v26, đúng filename, size,
...
- Không di chuyển tag v26. Nếu public v26 có lỗi nghiêm trọng, đổi Latest/download
