# Kế hoạch phát hành Hermes Vietnamese vi-v0.20.0-28

## Quyết định phạm vi

`vi-v0.20.0-28` là community prerelease cài được ngay sau khi vượt đủ cổng phát
...
- Tag `vi-v0.20.0-28` bất biến, trỏ đúng candidate commit; draft release chỉ được
  tạo từ tag này.
