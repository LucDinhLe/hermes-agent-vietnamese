...
**Source GO, Release NO-GO** cho ứng viên kế nhiệm `vi-v0.32.1-7`.
...
| Source hardening commit   | Chờ freeze exact candidate `-7`            |
| Tag dự kiến               | `vi-v0.32.1-7`                             |
| Desktop version dự kiến   | `0.32.1-vi.7`                              |
...
- `vi-v0.32.1-7` chỉ dựng Windows x64; Authenticode được ghi rõ `NotSigned`,
...
1. Commit/push exact source branch và tạo tag bất biến `vi-v0.32.1-7`.
...
2. Candidate `-5` và `-6` đã chứng minh phiên detached vẫn còn nguyên nhưng
   lifecycle chưa đi hết. Candidate `-7` phải tạo phiên project-addressable qua UI và
...
- Nếu promotion v32.1 hậu kiểm lỗi: trả `vi-v0.32.1-7` về draft/prerelease và
...
Đã push/tag và stage draft riêng tư cho các candidate bất biến `-2` đến `-6`;
